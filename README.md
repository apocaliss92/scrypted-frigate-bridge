...
Object detection will be forwarded to Scrypted, NVR will be able to use it as well and show events on the app. Audio events will also be forwarded, Advanced notifier is fully compatible with this plugin, any frigate detection can be used to configure AN (https://github.com/apocaliss92/scrypted-advanced-notifier)

### Frigate Audio Detector
Will ingest audio levels from Frigate, it's currently useful only for the audio detection rules on Advanced notifier
